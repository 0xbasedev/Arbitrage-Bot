...
export const BUNDLE_EXECUTOR_ABI = [{
  ...
  "inputs": [{"internalType": "address", "name": "_executor", "type": "address"}, {"internalType": "address", "name": "_wnative", "type": "address"}],
  "stateMutability": "payable",
  "type": "constructor"
}, {
  "inputs": [
    {"internalType": "uint256", "name": "_wnativeAmountToFirstMarket", "type": "uint256"},
